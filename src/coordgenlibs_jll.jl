...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import coordgenlibs_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("f6050b86-aaaf-512f-8549-0afff1b4d57f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "coordgenlibs", artifacts_toml) for e in artifacts["coordgenlibs"]]
...
if best_platform === nothing
    @debug("Unable to load coordgenlibs; unsupported platform $(triplet(platform_key_abi()))")
else
